...
public:
	...
	inline QString serverIdentifier() { return generateServerIdentifier(hostName_, portNumber_); }
	/// helper function to return the hostName of the current server
	inline QString hostName() { return hostName_; }
	...
	inline QStringList bufferNames() { return bufferNames_; }
	/// helper function to return the socket keys list of active TCP socket connections (continuous connections)
	inline QStringList activeTCPSocketKeys() { return QStringList(activeTCPSockets_.keys()); }
