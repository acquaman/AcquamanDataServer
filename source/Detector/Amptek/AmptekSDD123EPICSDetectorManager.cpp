...
AmptekSDD123EPICSDetectorManager::AmptekSDD123EPICSDetectorManager(AmptekSDD123Detector *detector, quint64 maxCountSize, QObject *parent) :
	AmptekSDD123DetectorManager(detector, maxCountSize, parent)
{
	connected_ = false;
	receivedConfigurationDataOnce_ = false;

	QString detectorBasePVName = detector->basePVName();
