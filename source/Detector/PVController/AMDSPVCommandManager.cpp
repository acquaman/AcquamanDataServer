...
void AMDSPVCommandManager::initiateAMDSCommands()
{
	...
	commands_.append( AMDSCommand(RequestEnablePV,    "0301", "Enable Scaler Channel",  7, 3, QStringList() << "0301"));
	commands_.append( AMDSCommand(RequestDisablePV,   "0301", "Disable Scaler Channel", 7, 3, QStringList() << "0301"));
