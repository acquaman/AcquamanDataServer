...
namespace AMDSClientRequestDefinitions {
	...
	#define AMDS_CLIENTREQUEST_FAIL_TO_HANDLE_SOCKET_KEY 20701  // 207xx error codes for client request
	#define AMDS_CLIENTREQUEST_FAIL_TO_HANDLE_STATUS 20702
	#define AMDS_CLIENTREQUEST_FAIL_TO_HANDLE_ERROR_MESSAGE 20703
	#define AMDS_CLIENTREQUEST_FAIL_TO_HANDLE_RESPONSE_TYPE 20704
	#define AMDS_CLIENTREQUEST_FAIL_TO_HANDLE_BUFFER_NAME 20705
	...
	#define AMDS_CLIENTREQUEST_FAIL_TO_HANDLE_CLIENT_REQUEST 20800
	#define AMDS_CLIENTREQUEST_INFO_REQUEST_DATA 20801
	#define AMDS_CLIENTREQUEST_INFO_CONTINUOUS_MSG_EXPIRED 20802
	#define AMDS_CLIENTREQUEST_INFO_CONTINUOUS_MSG_HAND_SHAKE 20803
	#define AMDS_CLIENTREQUEST_INFO_CONTINUOUS_MSG_HAND_SHAKE_DEREGISTER 20804
	#define AMDS_CLIENTREQUEST_ERR_FAILED_TO_RETRIEVE_DATA 20805
